...
public final class Medio extends Tanque {
    int nome;
    int danoBase;
    ...
    public void Caracterisrticas() {
        ...
        setVelocidade(60);  // menos velocidade que Leve
        setPoderDeFogo(40); // maior ataque que Leve
        setBlindagem(30);   // mesma blindagem que Leve
    }
